...
function TresorEditor(viewManager, serverIn, serverOut, player) {
    ...
    const panel              = GuiTools.createCenteredPanel(baseDiv, "700px", "685px").setGradient('#ababab', '#4b4b4b');
    GuiTools.createLineBreak(panel);
    const textAreaPass       = GuiTools.createPasswordField(panel, null, "600px", "30px", "Passwort", eventHandlersTextareaPass);
    GuiTools.createLineBreak(panel);
